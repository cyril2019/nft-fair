...
export default function Hooks() {
  ...
  return (
    <Flex direction="column" width="100vw" height="100vh" align="center" padding="40px">
      ...
      <Text
        ...
        mb="64px"
      >
        Our web3 connection hooks let you use our wallet conenction and network switching setup with
      ...
      <Flex width="400px" bg="gray.50" borderRadius="16px" direction="column" padding="20px">
        ...
        <Text>
          <strong>Wallet Address:</strong> {address ? `${address.slice(0, 16)}...` : 'N/A'}
        </Text>

        {address && (
          <Button onClick={disconnectWallet} mt="8px" variant="outline" bg="white">
            Disconnect
          </Button>
        )}

        <Text fontWeight="bold" fontSize="24px" alignSelf="center" mt="32px" mb="8px">
          Connect Wallet
        </Text>
